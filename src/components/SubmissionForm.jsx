        ...
        {showPopup && (
          <div className="popup-overlay">
            <div className="popup-content">
              ...
              <h2>Success!</h2>
              <p>
                Your registration has been successfully submitted. We are
                currently reviewing your information, and you will be able to
                log in once the verification process is complete, which may take
                up to one week.
              </p>
